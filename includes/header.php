...
/* -------- CSS -------- */
$cssCandidates = [
  ['/public/assets/style.css', __DIR__ . '/../public/assets/style.css'],
  ['/public/style.css',        __DIR__ . '/../public/style.css'],
  ['/assets/style.css',        __DIR__ . '/../assets/style.css'],
  ['/style.css',               __DIR__ . '/../style.css'],
];
$cssUrl = null;
foreach ($cssCandidates as [$url, $path]) { if (file_exists($path)) { $cssUrl = BASE_URL . $url; break; } }
if (!$cssUrl) $cssUrl = BASE_URL . '/public/assets/style.css';
...
<head>
  ...
  <style>
    ...
    .cart-badge{
      ...
      padding:0 5px; border-radius:999px; background:#22c55e; color:#083344;
...
<header class="navbar">
  <div class="container nav-row">
    ...
    <a class="brand" href="<?= BASE_URL ?>/public/index.php">Vivero El Prado</a>

    <nav class="nav-right">
      <?php if (!$esAdmin): ?>
        <a class="cart-link" href="<?= BASE_URL ?>/public/carrito.php" title="Ver carrito">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="#fff" aria-hidden="true">
            <path d="M7 18a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm10 0a2 2 0 1 0 .001 3.999A2 2 0 0 0 17 18ZM6.2 5l-.2-1a1 1 0 0 0-1-.8H3a1 1 0 1 0 0 2h1l2.1 9.2A2 2 0 0 0 8 16h8a2 2 0 0 0 1.9-1.4l2-6A1 1 0 0 0 19 7H7.4l-.3-2Z"/>
          </svg>
...
<aside id="drawerMenu" class="drawer" aria-hidden="true">
  ...
  <nav class="drawer-nav">
    <a href="<?= BASE_URL ?>/public/plantas.php">🌿 <span>Plantas</span></a>
    <a href="<?= BASE_URL ?>/public/macetas.php">🪴 <span>Macetas</span></a>
    <a href="<?= BASE_URL ?>/public/abono.php">🧪 <span>Abono</span></a>
    <a href="<?= BASE_URL ?>/public/tierra.php">🧱 <span>Tierra</span></a>

    <?php if (!$esAdmin): ?>
      <a href="<?= BASE_URL ?>/public/carrito.php">🛒 <span>Carrito <?= $cartCount>0 ? "($cartCount)" : "" ?></span></a>
    <?php endif; ?>

    <?php if ($usr && !$esAdmin): ?>
      <a href="<?= BASE_URL ?>/public/mis_pedidos.php">📦 <span>Mis pedidos</span></a>
    <?php endif; ?>
